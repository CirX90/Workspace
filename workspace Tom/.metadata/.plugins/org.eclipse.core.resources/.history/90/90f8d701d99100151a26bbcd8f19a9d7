...
public class Kontrollstation {
	...
	public static void main(String[] args) {
		...
		// Zufällige Seriennummer mit Math.random.
		...
		// zweiten Zug erstellen und einen Wagen hinzufügen.
		...
		// Aufruf Methode, Wagen von Zug1 an Zug2 anhängen.
		System.out.println("\nWagen werden umgehängt.\n");
		zug1.zugAnhaengen(zug1);

		// Ausgabe des ersten Zugs mit allen veränderten Informationen.
		zug1.info();
		System.out.format("............................................\n");
		System.out.format("Anzahl der Wagen: %d\n", zug1.getWagenAnzahl());
		System.out.format("Gesamtkapazität: %d Person(en)\n",
		...
		// Ausgabe des zweiten Zugs mit allen veränderten Informationen.
		zug2.info();
		System.out.format("............................................\n");
		System.out.format("Anzahl der Wagen: %d\n", zug2.getWagenAnzahl());
		System.out.format("Gesamtkapazität: %d Person(en)\n",
