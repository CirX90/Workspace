...
/**
 * Klasse simuliert zusätzlich einen Rennabbruch. Dazu wird ein zusätzlicher
 * Thread implementiert, der einmal pro Sekunde mit einer Wahrscheinlichkei von
 * 10% einen Rennabbruch auslöst. Dafür kennt die Klasse die Rennwagen und
...
public class Rennabbruch extends Thread {
	 ...
	 * Position eines Wagens gefüllt wird. Sollte dieser Zähler den gleichen
	 ...
	 * erhält. Der Threads wird eine Sekunde schlafen gelegt und prüft dann
	 * durch eine Bedingung ob die Abbruchvariable mit einer 1 übereinstimmt um
